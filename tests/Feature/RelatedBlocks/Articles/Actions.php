...
class Actions extends TestCase{
    ...
    private function parentBlock($relBlockAttrib = []) {
        ...
        $relatedBlock = factory(Block::class)->create(['panelLocation'=>null, 'page_id'=>null, 'parent'=>$block->id] + $relBlockAttrib)->specify();
    ...
    public function access_item_form_without_initial_data($assertion){
        $block = $this->parentBlock(['type'=>'articles']);
    ...
    public function access_item_form_when_block_is_setted_up($assertion){
        $block = $this->parentBlock(['type'=>'articles', 'parameters'=>'{"cropPhoto":"1","cropDimentions":"4:3","itemRouteBase":"article","settingsScale":"100","orderDirection":"desc"}']);
    ...
    public function edit_existing_item_in_the_block($assertion){
        $block = $this->parentBlock(['type'=>'articles', 'parameters'=>'{"itemRouteBase":"article","settingsScale":"100","orderDirection":"desc"}']);
    ...
    public function create_item_with_custom_image_sizes() {
        $block = $this->parentBlock(['type'=>'articles', 'parameters'=>'{"customSizes":1,"photoSizes":["6","3"],"itemRouteBase":"article","settingsScale":"100","orderDirection":"desc"}']);
    ...
    public function create_item_with_empty_custom_image_sizes() {
        $block = $this->parentBlock(['type'=>'articles', 'parameters'=>'{"customSizes":1,"itemRouteBase":"article","settingsScale":"100","orderDirection":"desc"}']);
