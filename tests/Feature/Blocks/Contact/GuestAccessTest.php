...
class GuestAccessTest extends Actions
{
    ...
    function guest_cannot_recieve_an_error_on_sending_incompleate_create_item_form(){
        $this->inContent()->dont_receive_an_error_on_sending_incompleate_create_item_form(false);
        $this->inHeader()->dont_receive_an_error_on_sending_incompleate_create_item_form(false);
        $this->relatedBlock()->dont_receive_an_error_on_sending_incompleate_create_item_form(false);
    }
