...
class Actions extends TestCase{
    ...
    public function access_item_form($assertion){
        $block = factory(Block::class)->create(['panelLocation'=>'content', 'page_id'=>1, 'name'=>'logo'])->specify();
    ...
    public function crop_photo($assertion){
        $block = factory(Block::class)->create(['panelLocation'=>'content', 'page_id'=>1, 'name'=>'logo', 'parameters'=>'{"cropPhoto":"on"}'])->specify();
