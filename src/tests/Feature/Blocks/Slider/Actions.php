...
//            exec('rm -rf ' . public_path('storage/photos'));
    ...
    public function access_item_form($assertion){
        $block = factory(Block::class)->create(['panelLocation'=>'content', 'page_id'=>1, 'name'=>'slider'])->specify();
    ...
    public function crop_photo($assertion){
        $block = factory(Block::class)->create(['panelLocation'=>'content', 'page_id'=>1, 'name'=>'slider', 'parameters'=>'{"cropPhoto":"on"}'])->specify();
