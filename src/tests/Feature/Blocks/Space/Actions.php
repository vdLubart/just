...
class Actions extends TestCase{
    ...
    public function access_item_form($assertion){
        $block = factory(Block::class)->create(['panelLocation'=>'content', 'page_id'=>1, 'name'=>'space', 'parameters'=>'{"height":"200px"}'])->specify();
    ...
    public function edit_block_settings($assertion){
        $block = factory(Block::class)->create(['panelLocation'=>'content', 'page_id'=>1, 'name'=>'space'])->specify();
