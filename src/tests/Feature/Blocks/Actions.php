...
class Actions extends TestCase{
    ...
    public function change_blocks_order($assertion){
        $htmlBlock = factory(Block::class)->create(['panelLocation'=>'content', 'page_id'=>1, 'name'=>'html']);
        $textBlock = factory(Block::class)->create(['panelLocation'=>'content', 'page_id'=>1, 'name'=>'text']);
    ...
    public function deactivate_block($assertion){
        $textBlock = factory(Block::class)->create(['panelLocation'=>'content', 'page_id'=>1, 'name'=>'text'])->specify();
    ...
    public function activate_block($assertion){
        $textBlock = factory(Block::class)->create(['panelLocation'=>'content', 'page_id'=>1, 'name'=>'text', 'isActive'=>0])->specify();
    ...
    public function delete_item_in_the_block_with_image($assertion){
        $block = factory(Block::class)->create(['panelLocation'=>'content', 'page_id'=>1, 'name'=>'gallery']);
