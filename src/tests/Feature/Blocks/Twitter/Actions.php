...
class Actions extends TestCase{
    ...
    public function access_item_form($assertion){
        ...
        $block = factory(Block::class)->create(['panelLocation'=>'content', 'page_id'=>1, 'name'=>'twitter', 'parameters'=>'{"account":"'.$account.'","widgetId":"'.$id.'"}'])->specify();
    ...
    public function edit_block_settings($assertion){
        $block = factory(Block::class)->create(['panelLocation'=>'content', 'page_id'=>1, 'name'=>'twitter'])->specify();
