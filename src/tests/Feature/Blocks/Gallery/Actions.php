...
class Actions extends TestCase{
    ...
    public function access_item_form($assertion){
        $block = factory(Block::class)->create(['panelLocation'=>'content', 'page_id'=>1, 'name'=>'gallery'])->specify();
    ...
    public function crop_photo($assertion){
        $block = factory(Block::class)->create(['panelLocation'=>'content', 'page_id'=>1, 'name'=>'gallery', 'parameters'=>'{"cropPhoto":"on","cropDimentions":"4:3"}'])->specify();
